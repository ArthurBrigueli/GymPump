...
const Login = ({navigation})=>{
    ...
    useEffect(()=>{
        ...
        const persistenceLogin = async()=>{
            ...
            if(token){
                const a = await axios.post('https://gym-pump-api-ruddy.vercel.app/api/authentication/login', {
                token: token
                })
    ...
    const handleLogin = async()=>{
        ...
        setLoading(true)
        try{
            const response = await axios.post('https://gym-pump-api-ruddy.vercel.app/api/login/user', {
                nome: user,
                senha: password
            })
